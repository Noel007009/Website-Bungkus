...
const noelData = {
    ...
    description: "Sebuah karya yang menggambarkan perjalanan hidup penuh lika-liku",
    author: "Bungkus",
    
    // Detail Karya
    details: {
        genre: "Inspirasi",
        theme: "Perjalanan Hidup",
        targetAudience: "Remaja dan Dewasa",
        releaseYear: 2024
    },
    ...
    features: [
        {
            ...
            description: "Cerita yang menginspirasi dan memberikan motivasi",
            icon: "📚"
        },
        {
            id: 2,
            title: "Pengalaman Nyata",
            description: "Berdasarkan pengalaman hidup yang autentik",
            icon: "🌟"
        },
        {
            id: 3,
            title: "Pelajaran Hidup",
            description: "Mengandung nilai-nilai kehidupan yang berharga",
            icon: "💡"
        }
    ],
